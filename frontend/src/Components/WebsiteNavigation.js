  ...
  return(
    ...
    <div class="container">
      <div class="row gy-3">
        ...
        <div class="order-lg-last col-lg-5 col-sm-8 col-8">
          <div class="d-flex float-end border rounded border-light bg-light">
            <a href="/CreateTemplate" class="border rounded py-1 px-3 nav-link d-flex align-items-center"> <i class="fas fa-shopping-cart m-1 me-md-2"></i><p class="d-none d-md-block mb-0 text-dark">Create Template</p> </a>
          </div>
        </div>
